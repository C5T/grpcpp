...
SERVER_CONTAINER_ID=$(GRPCPP_MODE=daemon ./grpcpp.sh examples/perftest/unary/server examples/perftest/unary/proto --http_server 5556)
...
./grpcpp.sh examples/perftest/unary/perftest examples/perftest/unary/proto --intervals 1
